...
function Projects() {
  ...
  const blogNation =
    {
      ...
      title: 'Blog Nation',
      description: 'A full stack blogging website, where users can login/signup, view, create and edit blogs.',
  ...
  const taskly = {
    image: TasklyImage,
    title: 'Taskly',
    description: 'A To-do list project made in React using functionalities of Context API, and storing data in the Local Storage.',
  ...
  const grooveBeats = {
    ...
    title: 'Groove Beats',
    description: 'A Responsive Spotify UI Clone, made as a practice and learning project',
  ...
  return (
    <div className='flex flex-col justify-center items-center dark:bg-background bg-white-background'>
      ...
      <div className='flex flex-wrap justify-around cards'>
          ...
          <Card image={TasklyImage} title={taskly.title} description={taskly.description} githubImg={githubLogo} websiteImg={websiteLogo} githubLink={taskly.githubLink} websiteLink={taskly.websiteLink}/>

          <Card image={GrooveBeatsImage} title={grooveBeats.title} description={grooveBeats.description} githubImg={githubLogo} websiteImg={websiteLogo} githubLink={grooveBeats.githubLink} websiteLink={grooveBeats.websiteLink}/>
